...
export class GeneralApi {
     ...
     * @param comment 
     */
    public apiGeneralComment(gameId?: string, instanceId?: number, shareUserId?: string, userName?: string, userImageUrl?: string, comment?: string, extraHttpRequestParams?: any): Observable<models.BoolResult> {
        return this.apiGeneralCommentWithHttpInfo(gameId, instanceId, shareUserId, userName, userImageUrl, comment, extraHttpRequestParams)
     ...
     * @param shareUserId 
     */
    public apiGeneralGameInstanceDetails(appId?: string, appSecret?: string, gameId?: string, instanceId?: number, shareUserId?: string, extraHttpRequestParams?: any): Observable<models.GameInstanceModel> {
        return this.apiGeneralGameInstanceDetailsWithHttpInfo(appId, appSecret, gameId, instanceId, shareUserId, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param take 
     */
    public apiGeneralGetComment(gameId?: string, instanceId?: number, shareUserId?: string, skip?: number, take?: number, extraHttpRequestParams?: any): Observable<models.PagingResultCommentModel> {
        return this.apiGeneralGetCommentWithHttpInfo(gameId, instanceId, shareUserId, skip, take, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
    ...
    /**
     * Upload customized image for sharing
     * 
     * @param gameId 
     * @param instanceId 
     * @param shareUserId 
     */
    public apiGeneralImage(gameId?: string, instanceId?: number, shareUserId?: string, extraHttpRequestParams?: any): Observable<models.BoolResult> {
        return this.apiGeneralImageWithHttpInfo(gameId, instanceId, shareUserId, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param comment 
     */
    public apiGeneralCommentWithHttpInfo(gameId?: string, instanceId?: number, shareUserId?: string, userName?: string, userImageUrl?: string, comment?: string, extraHttpRequestParams?: any): Observable<Response> {
        ...
        if (shareUserId !== undefined) {
            queryParameters.set('shareUserId', <any>shareUserId);
        }
     ...
     * @param shareUserId 
     */
    public apiGeneralGameInstanceDetailsWithHttpInfo(appId?: string, appSecret?: string, gameId?: string, instanceId?: number, shareUserId?: string, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param take 
     */
    public apiGeneralGetCommentWithHttpInfo(gameId?: string, instanceId?: number, shareUserId?: string, skip?: number, take?: number, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/api/General/Comment`;
     ...
     * @param shareUserId 
     */
    public apiGeneralImageWithHttpInfo(gameId?: string, instanceId?: number, shareUserId?: string, extraHttpRequestParams?: any): Observable<Response> {
